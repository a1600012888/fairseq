...
python3 train.py ${DATA_DIR} --ddp-backend=no_c10d \
    ...
    --save-interval-updates 25000 --keep-interval-updates 5 --no-epoch-checkpoints --skip-invalid-size-inputs-valid-test --save-dir ~/exps/fairseq/mix_electra_2-${EXEC_ID}
