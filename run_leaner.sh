...
echo 'Start Training'
python3 train.py ${DATA_DIR} --ddp-backend=no_c10d  --restore-file /home/tianyuan/exps/fairseq/masker-Robera-base-masker0.1/checkpoint_last.pt \
    ...
    --save-interval-updates 25000 --keep-interval-updates 5 --no-epoch-checkpoints --skip-invalid-size-inputs-valid-test --save-dir ~/exps/fairseq/masker-${EXEC_ID}
