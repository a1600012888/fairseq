...
EXEC_ID=Robera-base-masker-32768-p512-b256-c1.0
...
echo 'Start Training'
 NCCL_SOCKET_IFNAME=eth0 python3 -m torch.distributed.launch --nproc_per_node=4 --nnodes=2 --node_rank=0  \
    --master_addr="10.0.15.4" --master_port=1235 \
    train.py --fp16 ${DATA_DIR} --ddp-backend=no_c10d \
    --distributed-no-spawn \
    --task masked_lm --criterion mask_co_leaner --masker_lambda 1.0 \
