...
@register_model('roberta_norm_ml')
...
class RobertaLMHead(nn.Module):
    ...
    def forward(self, features, masked_tokens=None, **kwargs):
        ...
        x = self.layer_norm(x)
        tmp_weight = self.weight_norm(self.weight)
        # project back to size of vocabulary with bias
        x = F.linear(x, tmp_weight) + self.bias
        return x
...
@register_model_architecture('roberta_norm_ml', 'xlm_norm_ml')
