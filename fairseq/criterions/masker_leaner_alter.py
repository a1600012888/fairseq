...
@register_criterion('mask_leaner_alter')
class MaskLeanerAlterLoss(FairseqCriterion):
    """
    Implementation for the loss used in masked language model (MLM) training.
    """

    def __init__(self, args, task):
        super(MaskLeanerAlterLoss, self).__init__(args, task)
        ...
        self.explore_prob = args.explore_prob

    @staticmethod
    def add_args(parser):
        """Add criterion-specific arguments to the parser."""
        super(MaskLeanerAlterLoss,
              MaskLeanerAlterLoss).add_args(parser)
        ...
        parser.add_argument('--explore-prob', default=0.25, type=float,
                            help='the prob of using random mask')
    ...
    def forward(self, model, sample, reduce=True):
        ...
        if sample_size % batch_sz == 0:
            ...
            weight = weight / np.sum(weight) * sample_size
            #normalize_term = np.mean(weight)
