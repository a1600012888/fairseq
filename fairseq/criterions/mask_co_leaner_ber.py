...
@register_criterion('mask_co_leaner_ber')
class MaskLeanerCoLossBer(FairseqCriterion):
    """
    Implementation for the loss used in masked language model (MLM) training.
    """

    def __init__(self, args, task):
        super(MaskLeanerCoLossBer, self).__init__(args, task)
    ...
    def add_args(parser):
        ...
        super(MaskLeanerCoLossBer,
              MaskLeanerCoLossBer).add_args(parser)
    ...
    def forward(self, model, sample, reduce=True):
        ...
        if self.do_deterministic:
            ...
            with torch.no_grad():
                ...
                raw_masked_pos = torch.bernoulli(t_masker_out).type(torch.bool)
