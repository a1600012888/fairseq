...
UPDATE_FREQ=2
SEED=100
LOG_DIR=~/exps/fairseq/fc_weight_norm-${EXEC_ID}
...
python3 train.py ${DATA_DIR} --ddp-backend=no_c10d  \
    ...
    --arch roberta_base_norm_ml --sample-break-mode complete --tokens-per-sample ${TOKENS_PER_SAMPLE} \
    ...
    --save-interval-updates 25000 --keep-interval-updates 5 --no-epoch-checkpoints --skip-invalid-size-inputs-valid-test --save-dir ~/exps/fairseq/fc_weight_norm-${EXEC_ID}
